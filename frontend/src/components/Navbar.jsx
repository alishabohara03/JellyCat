...
//           <img className="w-5 cursor-pointer" src={assets.user} alt="User Icon" />
//           <div className="hidden group-hover:block absolute right-0 pt-4">
//             <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded shadow-md">
//               <p className="cursor-pointer text-gray-700 hover:text-black">Profile</p>
//               <p className="cursor-pointer text-gray-700 hover:text-black">Orders</p>
//               <p className="cursor-pointer text-gray-700 hover:text-black">Logout</p>
//             </div>
//           </div>
//         </div>
...
//                 <div className="relative group">
//                    <Link to='/login'> <img className="w-5 cursor-pointer" src={assets.user} alt="User Icon" /></Link> 
//                     <div className="hidden group-hover:block absolute right-0 pt-4">
//                         <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded shadow-md">
//                             <p className="cursor-pointer text-gray-700 hover:text-black">Profile</p>
//                             <p className="cursor-pointer text-gray-700 hover:text-black">Orders</p>
